...
namespace Moralis.Web3Api.Api
{
	...
	public class NativeApi : INativeApi
	{
		...
		public Block GetBlock (string blockNumberOrHash, ChainList chain, string subdomain=null)
		{
			...
			path = path.Replace("{" + "blockNumberOrHash" + "}", ApiClient.ParameterToString(blockNumberOrHash));
		...
		public LogEventByAddress GetLogsByAddress (string address, ChainList chain, string subdomain=null, string blockNumber=null, string fromBlock=null, string toBlock=null, string fromDate=null, string toDate=null, string topic0=null, string topic1=null, string topic2=null, string topic3=null)
		{
			...
			if(chain != null) queryParams.Add("chain", ApiClient.ParameterToString(chain));
			if(subdomain != null) queryParams.Add("subdomain", ApiClient.ParameterToString(subdomain));
			if(blockNumber != null) queryParams.Add("blockNumber", ApiClient.ParameterToString(blockNumber));
		...
		public string RunContractFunction (string address, string functionName, ChainList chain, string subdomain=null, string providerUrl=null)
		{
			...
			path = path.Replace("{format}", "json");
			path = path.Replace("{" + "address" + "}", ApiClient.ParameterToString(address));
			if(functionName != null) queryParams.Add("functionName", ApiClient.ParameterToString(functionName));
			if(chain != null) queryParams.Add("chain", ApiClient.ParameterToString(chain));
			if(subdomain != null) queryParams.Add("subdomain", ApiClient.ParameterToString(subdomain));
			if(providerUrl != null) queryParams.Add("providerUrl", ApiClient.ParameterToString(providerUrl));
